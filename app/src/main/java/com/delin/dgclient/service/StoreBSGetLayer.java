 ...
 */
public class StoreBSGetLayer extends BizService {



    public StoreBSGetLayer(Context context) {
        super(context);
    }

    @Override
    protected BizServiceResult onExecute() throws Exception {
        JSONObject jsonObject = (JSONObject) remoteJSON(RemoteService.REQUEST_METHOD_GET, Config.URL_SERVER_GET_LAYER);
